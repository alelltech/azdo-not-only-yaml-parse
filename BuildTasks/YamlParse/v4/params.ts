...
// import { getInput, getVariable, warning } from "azure-pipelines-task-lib";
...
// export function parseInput({source, sourceType, queries}: Inputs): InputsParsed {
...
//   const parsedContent = loadAll(getContent(sourceContent))
